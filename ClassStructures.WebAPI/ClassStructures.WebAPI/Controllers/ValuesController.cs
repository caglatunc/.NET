...
using ClassStructures.WebAPI.Services;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace ClassStructures.WebAPI.Controllers;
[Route("api/[controller]/[ACTİON]")]
[ApiController]
public class ValuesController : ControllerBase
{
    ...
    [HttpGet]
    public IActionResult GetProductListForReport()
    {
