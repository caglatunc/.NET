...
namespace EntityFrameworkCore.Relational.WebApi.Migrations
{
    ...
    [Migration("20240118183854_MoreAndMoreRelationBetweenUserAndRole")]
    partial class MoreAndMoreRelationBetweenUserAndRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("EntityFrameworkCore.Relational.WebApi.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrameworkCore.Relational.WebApi.Models.User", null)
                        .WithMany()
